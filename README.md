...
AVIF viewing and saving support transparency in still images and animations. Static AVIF saves preserve the edited 8-bit RGBA pixels; supported multi-frame sequences also retain timing and loops. Single-frame sequence export and animation conversion between formats remain limited.
