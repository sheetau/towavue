...
AVIF viewing supports auxiliary transparency in still images and animations. Supported multi-frame sequences can also be saved as AVIF with frame timing, loops, and transparency retained. Static AVIF transparency export, single-frame sequence export, and animation conversion between formats remain limited.
