...
AVIF viewing and saving support transparency in still images and animations. Static AVIF saves preserve the edited 8-bit RGBA pixels; supported sequences, including single-frame sequences, also retain timing and loops. Animation conversion between formats remains limited.
