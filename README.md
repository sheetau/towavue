...
Viewing support does not imply lossless export or animation-preserving export for every format. Supported APNG exports retain frames, timing, loops, and separate poster images. Other animated-image export formats remain limited.
