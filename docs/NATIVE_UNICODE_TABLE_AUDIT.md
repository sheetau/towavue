...
The new data/generator inputs currently remain in ignored audit storage. Neither they nor this new notice are yet included in the fixed v5 material catalog. Connect their verified originals and provenance to the final material delivery without overwriting old fixed kits. Fontconfig, HarfBuzz and libunibreak data references, the other named embedded-code/NOTICE cases, final source access and all installer/quality gates remain open.
