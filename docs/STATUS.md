...
Documentation consolidation is committed at 4b09ff1: README is an English product introduction and development status is centralized here. APNG export now shares display compositing with and without a separate poster. Next: remaining animation-preserving export/conversion policy or the image-navigation performance work below. Do not recreate completed APNG work.
...
- Verified code: **2026-09-12 APNG display/export compositing parity**, based on 4b09ff1. Local verification: 699 tests passed (app 391, core 67, runtime 237, integration 4), 22 ignored; fmt, Clippy, Release passed. These checks cover this code, not future changes or physical UI interaction.
...
- **2026-09-12 — APNG display/export parity:** reproduced the posterless OVER rounding mismatch, reused streaming display compositing for export, and replaced tolerance/FFmpeg-reference assertions with exact displayed-edit comparisons. Broadened streaming, cancellation, corruption and target-protection coverage to both poster layouts. Verification is above; remaining formats/performance are next, not distribution.
