...
APNG display/export compositing is aligned at 98e947f; texture-cache ownership improved at 5f720b2. GIF→GIF saving preserves animation, exact-fit palettes, and newly transparent regions. Next: WebP/AVIF animation-preserving export/conversion policy, GIF over-budget palette quality/metadata and long-animation cost, cold/other-format image performance, and actual OS-input validation when available. Do not recreate completed APNG, GIF frame/control/palette-budget preservation, or cache-lifetime work.
...
- Verified code: **2026-09-12 GIF palette/transparency correction**, based on 7ddc452. Full workspace: 708 passing tests (app 391, core 67, runtime 246, integration 4), 22 ignored. fmt, Clippy and Release passed. These are not physical-input, all-format quality, or long-animation performance checks.
...
| E01 | Audio-only output, normalization/channel options, metadata UI, PNG/JPEG/static WebP fields, APNG export with posters/shared compositing, GIF frame/timing/repeat/exact-fit palettes and transparent-frame clearing | WebP/AVIF animation-preserving export and conversion policy; GIF over-budget quantization/extension/metadata fidelity and long-animation cost; full 16-bit/ICC; AlbumArtist/EXIF/IPTC/COM/unknown or Extended XMP and cross-format metadata |
...
- **2026-09-12 — GIF palette/transparency:** replaced lossy palette staging with RGBA snapshots and exact-fit local palettes; normalized disposal prevents transparent-frame ghosts. Builds on animation/control preservation at 7ddc452. Continue remaining format/UI/performance work, not distribution.
...
- **4b09ff1 — documentation consolidation:** eight main documents became five, approximately 2.43 MB → 40 KB; 31 requirement IDs and 186 local links/anchors checked. Historical evidence remains at 2d72e75; packaging provenance stays separate. No code/CI changes.
