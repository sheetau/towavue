...
if ($inventory.schema_version -ne 1 -or $inventory.components.Count -ne 10) { throw 'Incomplete native shader inventory.' }
...
Write-Output 'Ten static/API-header/generator inputs only; no installation, runtime change or distribution approval.'
