...
if ($inventory.schema_version -ne 1 -or $inventory.packages.Count -ne 44) { throw 'Incomplete source supplement inventory.' }
if ($inventory.additional_notices.Count -ne 5) { throw 'Incomplete additional notice inventory.' }
