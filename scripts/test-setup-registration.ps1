...
try {
    ...
    Write-Output "PASS: native shortcut fields, typed registry values, Unicode paths, collision/identity/refusal, lock/retry, replacement and extra-data preservation, missing state and junction guards. Test GUID registry key and generated shortcuts removed. Evidence: $trialRoot"
}
