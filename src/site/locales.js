...
export const locales = {
  en: {
    ...
    features: [
      { id: "workspace", title: "All your media, together", description: "A photo, a film, a favorite track. Browse images, video, and audio with one familiar set of controls.", image: "workspace.webp", alt: "A black-and-white flower photograph in the towavue image viewer" },
