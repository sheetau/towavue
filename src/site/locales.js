...
export const locales = {
  en: {
    ...
    features: [
      { id: "workspace", title: "All your media, together", description: "A photo, a film, a favorite track. Open them side by side in tabs, with one familiar set of controls.", image: "workspace.webp", alt: "towavue showing an image with image, video, and audio tabs" },
      { id: "speed", title: "Built for speed", description: "Native GPU rendering keeps viewing responsive. Hardware video decoding puts your GPU to work, too.", image: "video.webp", alt: "Video playback with a thumbnail preview above the seek bar" },
    ...
    demo: {
      ...
      hint: "Try the tabs and seek bar. A little look inside towavue.",
      audioHint: "Select a track to explore the playlist. This preview is silent.",
  ...
  ja: {
    ...
    featureLabel: "機能を見る",
    features: [
      { id: "workspace", title: "画像も、動画も、音声も", description: "写真、映画、お気に入りの曲。タブに並べて、いつもの操作で楽しめます。", image: "workspace.webp", alt: "画像・動画・音声のタブが並ぶtowavueの画像ビューアー" },
      { id: "speed", title: "待たせないための設計", description: "GPUによるネイティブ描画で、軽快な閲覧を。動画のハードウェアデコードにも対応しています。", image: "video.webp", alt: "シークバー上にサムネイルプレビューを表示した動画再生画面" },
    ...
    demo: {
      ...
      audioSeek: "音声の再生位置",
      playlist: "サンプル音声リスト",
      hint: "タブとシークバーを操作して、使い心地をお試しください。",
      audioHint: "リストから曲を選んでお試しください。このプレビューでは音は出ません。",
      silent: "無音プレビュー",
      loading: "プレビューを読み込み中…",
